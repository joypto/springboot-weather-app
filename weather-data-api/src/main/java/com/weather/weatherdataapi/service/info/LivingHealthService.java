...
//    public Integer convertHealthInfoToScore(Integer wthIdx) {
//        Integer score = HealthScoreUtil.convertHealthWthIdxToScore(wthIdx);
//        return score;
//    }
//
//    // 보건기상지수 중 식중독 지수의 점수 반환
//    public Integer convertFoodPoisonInfoToScore(Integer wthIdx) {
//        if (wthIdx <= 55) {
//            return 100;
//        } else if (wthIdx <= 70) {
//            return 70;
...
//    public Integer convertUvInfoToScore(Integer wthIdx) {
